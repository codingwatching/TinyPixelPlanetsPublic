...
func _ready():
	...
	match id:
		...
		9:
			...
			$Sprite2D.texture = load("res://textures/blocks2X/big_tree"+ isSnow+".png")
			position.x += 0.5
			position.y -= 23
		6,7:
			$CollisionShape2D.disabled = true
		76:
			$CollisionShape2D.disabled = true
			$Sprite2D.texture = load("res://textures/blocks2X/exotic_tree1.png")
			position.y -= 21
		11:
			$CollisionShape2D.disabled = true
			$Sprite2D.texture = load("res://textures/blocks2X/sapling.png")
			$check.start(randf_range(120,600))
		85:
			$CollisionShape2D.disabled = true
			$Sprite2D.texture = load("res://textures/blocks2X/exotic_sapling.png")
			$check.start(randf_range(120,600))
		20:
			$Sprite2D.texture = load("res://textures/blocks2X/glass_atlas.png")
			$Sprite2D.region_enabled = true
		80:
			$Sprite2D.texture = load("res://textures/blocks2X/wood_window_atlas.png")
			$Sprite2D.region_enabled = true
		81:
			$Sprite2D.texture = load("res://textures/blocks2X/copper_window_atlas.png")
			$Sprite2D.region_enabled = true
		...
		match id:
			10:
				if world.get_block_id(pos - Vector2(0,1),layer) == 10 or world.get_block_id(pos + Vector2(0,1),layer) == 10:
					$Sprite2D.texture = load("res://textures/blocks2X/log_v.png")
				elif world.get_block_id(pos - Vector2(1,0),layer) == 10 or world.get_block_id(pos + Vector2(1,0),layer) == 10:
					$Sprite2D.texture = load("res://textures/blocks2X/log_h.png")
				else:
					$Sprite2D.texture = load("res://textures/blocks2X/log_front.png")
			77:
				if world.get_block_id(pos - Vector2(0,1),layer) == 77 or world.get_block_id(pos + Vector2(0,1),layer) == 77:
					$Sprite2D.texture = load("res://textures/blocks2X/exotic_log_v.png")
				elif world.get_block_id(pos - Vector2(1,0),layer) == 77 or world.get_block_id(pos + Vector2(1,0),layer) == 77:
					$Sprite2D.texture = load("res://textures/blocks2X/exotic_log_h.png")
				else:
					$Sprite2D.texture = load("res://textures/blocks2X/exotic_log_front.png")
			18,14:
